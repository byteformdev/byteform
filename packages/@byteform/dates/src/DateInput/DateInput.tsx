        ...
        const displayValue = useMemo(() => {
            ...
            if (Array.isArray(selectedValue)) {
                if (type === "range" && selectedValue.length === 2) {
                    ...
                    return `${dayjs(start).format(dateFormat)} - ${dayjs(
                        end
                    ).format(dateFormat)}`;
                    ...
                    return dayjs(selectedValue[0]).format(dateFormat);
                }
                return "";
            }

            return dayjs(selectedValue).format(dateFormat);
        }, [selectedValue, dateFormat, type]);
                ...
                <div className="relative z-50">
                    ...
                    >
                        <div
                            ...
                            className={cx(
                                "z-50 shadow-lg rounded-md overflow-hidden p-2 shadow-md",
                                "border",
                                theme === "light"
...
DateInput.displayName = "@byteform/dates/DateInput";
